...
class PrayerLog(Base):
    ...
    prayed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    was_on_time: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
